...
ClapTrap::ClapTrap()
{
	std::cout << blue << "ClapTrap" << green << " no name constructor called" << reset << std::endl;
	this->_name = "ClapTrap";
}

ClapTrap::~ClapTrap()
{
	std::cout << blue << "ClapTrap" << red << " destructor called" << reset << std::endl;
}

ClapTrap::ClapTrap(std::string name)
{
	std::cout << blue << "ClapTrap" << green << " constructor called" << reset << std::endl;
	this->_name = name;
}
...
{
	std::cout << green << "ClapTrap operator = called" << reset << std::endl;
